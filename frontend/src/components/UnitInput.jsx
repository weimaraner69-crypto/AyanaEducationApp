    ...
    <div className="min-h-screen bg-[#F8FAFC] p-6 flex flex-col items-center">
      ...
      <div className="w-full max-w-md space-y-6 text-slate-900">
        ...
        <button
          ...
          onClick={onGenerate}
          className="w-full py-7 bg-indigo-600 text-white font-black text-xl rounded-[2.5rem] shadow-2xl flex items-center justify-center gap-4 active:scale-95 disabled:opacity-30 shadow-indigo-100"
        >
          AI解析を開始
        </button>
      </div>
