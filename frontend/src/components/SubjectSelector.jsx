    ...
    <div className="grid grid-cols-3 gap-3">
      {Object.entries(subjectsConfig).map(([key, config]) => (
        <button
          ...
          className="group p-4 bg-white border-b-4 border-slate-100 hover:border-indigo-500 rounded-2xl shadow-sm transition-all flex flex-col items-center gap-2 active:scale-95"
        >
